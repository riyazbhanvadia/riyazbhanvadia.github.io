    ...
    $('[data-mz-role="contact-form"]').each(function() {
        ...
        $form.on('submit', function(e) {
            ...
            $.getJSON(action + $form.serialize() + "&callback=?").then(function(res) {
                if (res === "OK") {
                    $form.html('<i class="fa fa-check-circle" aria-hidden="true"></i><h3 class="mz-sucess"><i class="fa fa-smile-o" aria-hidden="true"></i>&nbsp;Thank you! You should receive a confirmation shortly.</h3');
                } else {
